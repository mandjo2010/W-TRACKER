...
export default class CreateExercise extends Component {
  ...
  render() {
    return (
      <div>
        <h5 className="text-xs text-white py-2">Create New Task</h5>
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <label className="text-xs text-white py-2">Description : </label>
            <input
              type="text"
              required
              className="form-control"
          ...
          <div className="form-group">
            <label className="text-xs text-white py-2">
          ...
          <div className="form-group">
            <label className="text-xs text-white py-2">Date : </label>
            <div>
              <DatePicker
